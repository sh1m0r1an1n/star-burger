...
if [ -f /etc/letsencrypt/live/burger-star.ru/fullchain.pem ]; then
    ...
    sudo cp /etc/letsencrypt/live/burger-star.ru/fullchain.pem infrastructure/nginx/ssl/
    sudo cp /etc/letsencrypt/live/burger-star.ru/privkey.pem infrastructure/nginx/ssl/
    sudo chown root:root infrastructure/nginx/ssl/*
...
sudo cp infrastructure/scripts/systemd/certbot-renewal.service /etc/systemd/system/
sudo cp infrastructure/scripts/systemd/certbot-renewal.timer /etc/systemd/system/
